defmodule TimeManagement.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{avatar: "some avatar", email: "some email", fname: "some fname", lname: "some lname", password: "some password"}
    @update_attrs %{avatar: "some updated avatar", email: "some updated email", fname: "some updated fname", lname: "some updated lname", password: "some updated password"}
    @invalid_attrs %{avatar: nil, email: nil, fname: nil, lname: nil, password: nil}
